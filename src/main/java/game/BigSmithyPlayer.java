 ...
 *
 */
public class BigSmithyPlayer extends Player {

	/**
	 * 
	 */
	public BigSmithyPlayer(String name, GameDeck gamedeck) {
		this.setName(name);
	...
	public void takeTurn() {
		...
		//Action card phase
		if (hand.contains(CardType.SMITHY) > 0 ) {
			System.out.println("I have a smithy in my hand!");
			this.doAction(hand.getCard(CardType.SMITHY));
		}
